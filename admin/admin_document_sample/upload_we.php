...
<?php 
    if(isset($_POST['btn_submit'])){
        ...
        if($v_file["name"] != ""){
            ...
            if(move_uploaded_file($v_file["tmp_name"], "../../file/file_document_sample/".$new_name)){
                if(file_exists("../../file/file_document_sample/".$v_old_file)){
                    unlink("../../file/file_document_sample/".$v_old_file);
                }
            }else{
                $new_name = $v_old_file;
            }
...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <?= @$sms ?>
            <h2><i class="fa fa-plus-circle fa-fw"></i>Upload File Word or Excel</h2>
        </div>
    </div>
    <br>
    <br>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label>Upload File Word or Excel : </label>
