                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group form-md-line-input">
                                    <input type="text" class="form-control" name="txt_name" placeholder="Enter your code here ...." required="required" autocomplete="off">
                                    <label>Employee ID
                                        <span class="required" aria-required="true">*</span>
                                    </label>
                                    <span class="help-block">Enter Your Code here ....</span>
                                </div>
                                <div class="form-group form-md-line-input">
