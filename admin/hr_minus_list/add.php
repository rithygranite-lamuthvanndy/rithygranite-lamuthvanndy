...
<?php 
    if(isset($_POST['btn_submit'])){
        ...
        $query_add = "INSERT INTO tbl_hr_item_rubber(
                ir_name,
                ir_type,
                ir_unit,
                ir_note
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <input type="text" name="txt_type" class="form-control" required="">
                                <label>Unite / គិតជា
                                    <span class="required" aria-required="true">*</span>
                                </label>
                                <input type="text" name="txt_unit" class="form-control" required="">
                                <br>
