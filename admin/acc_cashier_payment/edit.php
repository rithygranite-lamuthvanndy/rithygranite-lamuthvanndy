                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <input type="number" value="<?= $row_old_data->accca_number ?>" name="txt_number" class="form-control" required="">
                                <br>

                                <label>Account Name
                                    <span class="required" aria-required="true">*</span>
                                </label>
                                <input type="text" value="<?= $row_old_data->accca_account_name ?>" name="txt_name" class="form-control" required="">
                                <br>
                                ...
                                <select class="form-control" name="txt_type" required="required">
                                    ...
                                    <?php 
                                        ...
                                        while ($row_data = mysqli_fetch_object($v_select)) {
                                            if($row_data->accta_id == @$row_old_data->accca_account_type){
