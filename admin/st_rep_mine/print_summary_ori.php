        ...
        <table>
            <thead>
                <tr role="row" class="text-center">
                            ...
                            <th rowspan="2" class="text-center">ល.រ<br>STT</th>
                            <th rowspan="2" class="text-center">បរិយាយ<br>Mô tả</th>
                            <th rowspan="2" class="text-center">ស្តុក<br>Nhập và xuất kho</th>
                            <th rowspan="2" class="text-center">សរុប<br>Tổng</th>
                            <th colspan="3" class="text-center">ត្រីមាសទី 1 <br>Quý 1</th>
                            <th colspan="3" class="text-center">ត្រីមាសទី 2<br>Quý 2</th>
                            <th colspan="3" class="text-center">ត្រីមាសទី 3<br>Quý 3</th>
                            <th colspan="3" class="text-center">ត្រីមាសទី 4<br>Quý 4</th>
                </tr>
             </thead>
                    <tbody>
                  <?php
                ...
                while ($row_summary = mysqli_fetch_object($v_result_summary)) {
                    ...
                    $cate_min_id=$row_summary->stca_id;
                        ...
                        ?>
                         ...
                         <tr >
                            <td style="border-top: none;border-bottom: none;"><?php echo ++$i; ?></td>
