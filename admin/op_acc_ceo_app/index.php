...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-fw fa-map-marker"></i> CEO Approved List</h2>
        </div>
    </div>
    <br>
    <br>
                ...
                <tbody>
                    <?php
                        $get_data=$connect->query("SELECT * FROM tbl_acc_request_form AS A
                            ...
                            WHERE (
                            -- A.st_check_by AND A.adm_check_by 
                            -- AND A.sub_man_app_by AND A.man_app_by 
                            -- AND A.admin_check_off_by AND A.pur_check_id 
                            -- AND A.acc_check_by AND A.acc_man_app_by
                             A.acc_check_by 
                            ) <>0
                        ...
                        while ($row = mysqli_fetch_object($get_data)) {
                            echo '<tr>';
                                ...
                                echo check_list($row->req_id,$row->ceo_app_by);
                                echo '</td>';
