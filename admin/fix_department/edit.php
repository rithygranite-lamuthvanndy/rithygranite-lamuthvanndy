...
<?php 
    if(isset($_POST['btn_submit'])){
        ...
        $query_update = "UPDATE `tbl_fix_depart` 
            SET 
                `depart_locat`='$v_locat',
                `dep_name`='$v_name',
                `dep_note`='$v_note'
            WHERE `dep_id`='$v_id'";
...
// get old data 
    ...
    $old_data = $connect->query("SELECT * FROM tbl_fix_depart WHERE dep_id='$edit_id'");
                                ...
                                <select name="cbo_locat" id="input" class="form-control myselect2" required="required">
                                    ...
                                    <?php 
                                        ...
                                        while ($row=mysqli_fetch_object($sql)) {
                                            if($row_old_data->depart_locat==$row->locat_id)
