...
if (isset($_POST['btn_submit'])) {
    ...
    $v_user_id = mysqli_escape_string($connect, @$_SESSION['user']->user_id);
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="txt_bar_code" required="" autocomplete="off">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select type="text" class="form-control myselect2" name="cbo_pro_type" required="" autocomplete="off">
                                        <option value="">=== Select and choose===</option>
                                        <?php
                                        // $get_select=$connect->query("SELECT * FROM tbl_st_product_type_list ORDER BY name ASC");
                                        // while($row_data = mysqli_fetch_object($get_select)){
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="txt_pro_alert" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6" style="padding-left: 0px;">
                            <div action="save_photo.php" class="dropzone"></div>
                        </div>
                        <div class="col-md-6">
    ...
    $(document).ready(function() {
        ...
        $('#modal').on('hidden.bs.modal', function() {
            ...
            if (iframe_statue == '../st_product_type_list/index.php?view=iframe') {
                ...
                let v_main_sub = $('select[name=cbo_substance] option:selected').val();
