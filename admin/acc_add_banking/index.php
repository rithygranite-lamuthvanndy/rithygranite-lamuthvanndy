...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-fw fa-map-marker"></i> Add Banking</h2>
        </div>
    </div>
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active">
            <a href="#activity" data-toggle="tab">Banking</a>
        </li>
        <li role="presentation">
            <a href="#apptransaction" data-toggle="tab">App transactions</a>
        </li>
        <li role="presentation">
        ...
        <li role="presentation">
            <a href="#receipts" data-toggle="tab">Receipts</a>
        </li>
    </ul>
    <div class="tab-content">
                    ...
                    <div class="col-lg-3 col-xs-6">
                      ...
                      <div class="small-box">
                        <div class="inner bg-aqua">
                            ...
                            <table width="100%">
                                <tr>
                                    <td><h1><b>$ 150.00</b></h1></td><td></td>
                                </tr>
                                <tr>
                                    <td><h4>BANK BALANCE</h4></td><td class="text-right"><small>Updated moments ago</small></td>
                                </tr>
                            </table>
                        </div>
                        <div class="inner bg-red">
                            <table width="100%">
                                <tr>
                                    <td><h1><b>$ 150.00</b></h1></td><td rowspan="2" class="text-right"><h2>20</h2></td>
                                </tr>
                                <tr>
                                    <td><h4>IN SYSTEMS</h4> </td>
                                </tr>
                            </table>
                        </div>
                      </div>
            ...
            <div class="row">
                <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="btn-group">
                          <button type="button" class="btn btn-info">For review (22)</button>
                          <button type="button" class="btn btn-info">Categorized</button>
                          <button type="button" class="btn btn-info">Excluded</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="active tab-pane" id="apptransaction">
        </div>
        <div class="active tab-pane" id="rules">
        </div>
        <div class="active tab-pane" id="tags">
        </div>
        <div class="active tab-pane" id="receipts">
        </div>
    </div>
</div>
