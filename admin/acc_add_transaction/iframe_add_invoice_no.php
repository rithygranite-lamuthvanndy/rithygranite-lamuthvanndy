...
<?php
    ...
    if(isset($_POST['btn_submit'])){
        ...
        $v_voucher_no = @$_POST['txt_voucher_no'];
                    ...
                    <div class="form-body">
                       <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    <label>Time : </label>
                                    <input type="text" class="form-control" required name="txt_time" value="<?= date('h:i:a') ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required name="txt_voucher_no">
                                </div>
                                <div class="form-group">
                                    <label>Name : </label>
