...
<?php
    if(@$_GET['v_id']){
        $v_id=@$_GET['v_id'];
        $get_data=$connect->query("SELECT A.*,accpro_name,accca_number,accca_account_name,accdr_voucher_no
            FROM tbl_acc_add_transaction_detail AS A 
            LEFT JOIN tbl_acc_project AS B ON A.project_id=B.accpro_id
            LEFT JOIN tbl_acc_chart_account AS C ON A.chart_acc_id=C.accca_id
            LEFT JOIN tbl_acc_add_transaction AS D ON A.transation_id=D.accad_id
            LEFT JOIN tbl_acc_cash_record AS E ON D.accad_cash_rec_id=E.accdr_id
            WHERE transation_id='$v_id'");
    }
?>
<div class="portlet light bordered">
    ...
    <div class="row">
        <div class="panel-heading text-center">
            <h2>Add Transation Information</h2>
        </div>
    </div>
