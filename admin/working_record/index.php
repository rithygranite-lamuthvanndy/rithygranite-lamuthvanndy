...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-fw fa-map-marker"></i> Working Record</h2>
        </div>
    </div>
    <br>
    <div class="row">
                            ...
                            if($v_topic != "" AND $v_employee == ""){
                                ...
                                $get_data = $connect->query("SELECT 
                                    ...
                                    FROM  tbl_working_record AS A 
                                        ...
                                        WHERE wr_date BETWEEN '$v_from' AND '$v_to' AND A.wr_employee='$v_employee'
                                    ORDER BY wr_id DESC");
                                ...
                                $get_data = $connect->query("SELECT 
                                    ...
                                    FROM  tbl_working_record AS A 
                                        ...
                                        LEFT JOIN tbl_company AS C ON C.com_id=A.wr_company
                                        LEFT JOIN tbl_working_department AS D ON D.dep_id= A.wr_department
                                        WHERE wr_date BETWEEN '$v_from' AND '$v_to'
                                    ORDER BY wr_id DESC");
