<?php 
    $menu_active =20;
    $left_active =0;
    $layout_title = "Add Transation Amount";
     ...
     if(isset($_POST['btn_save_close'])){
        ...
        foreach ($v_acc_id as $key => $value) {
            if($value){
                ...
                $new_tran_note=$v_tran_note[$key];
                $new_doc_ref=$v_doc_ref[$key];
                $new_qty=convertStringToDouble($v_qty[$key]);
                $new_unit_price=convertStringToDouble($v_unit_price[$key]);
                $new_amo=convertStringToDouble($v_amo[$key]);
                $new_acc_id=$v_acc_id[$key];
                $new_acc_debit=convertStringToDouble($v_acc_debit[$key]);
...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <?= @$sms ?>
            <h2><i class="fa fa-plus-circle fa-fw"></i>Create Transaction Amount</h2>
        </div>
    </div>
                       ...
                       <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="col-xs-4">
                                    <div class="form-group">
                                        ...
                                        <select name="cboType" onchange="changeType(this)" id="inputCboType" class="form-control myselect2" required="required">
                                            ...
                                            <option value="5">Transfer Fund</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                ...
                                <div class="col-xs-4">
                                    <div class="form-group">
                                        <label>Name : </label>
                                        <input type="text" name="txt_name" id="inputTxt_name" class="form-control" readonly="">
                                    </div>
                                </div>
                            </div>
