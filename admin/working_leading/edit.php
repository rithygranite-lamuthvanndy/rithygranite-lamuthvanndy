...
<?php 
    if(isset($_POST['btn_submit'])){
        ...
        $query_update = "UPDATE `tbl_working_department` 
            SET 
                `dep_name`='$v_name',
                `dep_note`='$v_note',
                `dep_user_id`='$v_user_id'
            WHERE `dep_id`='$v_id'";
...
// get old data 
    ...
    $old_data = $connect->query("SELECT * FROM tbl_working_department WHERE dep_id='$edit_id'");
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <input type="text" value="<?= $row_old_data->dep_name ?>" name="txt_name" class="form-control" required="">
                                <br>
