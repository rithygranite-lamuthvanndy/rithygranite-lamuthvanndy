...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-fw fa-map-marker"></i> Leading (=Doing)</h2>
        </div>
    </div>
    <br>
            ...
            <table class="table table-striped table-bordered table-hover dataTable dtr-inline collapsed" id="sample_1" role="grid" aria-describedby="sample_1_info" style="width: 1180px;">
                <thead>
                    <tr role="row" class="text-center">
                        ...
                        <th>Note</th>
                        <th>Approved by</th>
                        <th>Check Organizing</th>
                        <th class="text-danger">Check Leading</th>
                        <th>User</th>
                        <th>Date_Audit</th>
                    ...
                    <?php
                        ...
                        if(isset($_POST['btn_search'])){
                            ...
                            if($v_topic != "" AND $v_employee == ""){
                                ...
                                LEFT JOIN tbl_working_check_controlling AS WCC ON A.wfor_check_leading=WCC.wfcc_id
                        ...
                        while ($row = mysqli_fetch_object($get_data)) {
                            echo '<tr>';
                                ...
                                echo '<td>'.$row->wfcd_name.'</td>';
                                echo '<td class="text-center text-danger">
                                        <a href="check_leading.php?sent_id='.$row->wfor_id.'">
