...
<div class="portlet light bordered">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">
                    ...
                    Create Stock <?= (($_SESSION['action']==2)?'In':'Out') ?> <?= $_SESSION['title'] ?>
                </h3>
            </div>
    ...
    ['.$row_data->stpron_code.'] '.$row_data->stpron_name_vn.' == '.$row_data->stpron_name_kh.'
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12 text-center">
                                    ...
                                    <button type="submit" name="btn_save_in" class="btn blue" id="btn_save"><i class="fa fa-save fa-fw"></i>Save</button>
...
<script>
    $(document).ready(function()
    {
        ...
        // {
        //     if(qty==0 || pricevn==0 || pricedollar==0 || name == -1)
        //     {
        //     if(qty == 0)
        //     {

        //         alert('Please input value of QTY');
        ...
        //         alert('Please input value of Price in Vietnam');
        //         // $("#form").submit(function(e){
        //             e.preventDefault();
        ...
        //     }
        //     else if(pricedollar == 0)
        //     {

        //         alert('Please input value of Price in Dollar');
        //             e.preventDefault();
