    ...
    <div class="portlet-body">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-truck fa-flip-horizontal"></i> Create Stock <?= (($_SESSION['action']==2)?'In':'Out') ?> <?= $_SESSION['title'] ?></h3>
            </div>
                                ...
                                <table id="myTable" class="table table-bordered" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="width: 15%;">ម៉ាស៊ីន</th>
                                        ...
                                        <tr class="my_form_base" style="background: red; display: none;">
                                            ...
                                            <td>
                                                <select class="form-control" name="cbo_pro_code[]">
                                                    <option value="n">== Please Choose and Select ==</option>
                                                    <?php 
...
<script type="text/javascript">
    ...
    $("tbody").on('change', 'tr td:nth-child(3) select', function () {
        ...
        data_unit_name=$(this).find('option:selected').attr('data_unit_name'); 
            $(this).parents('tr').find('td:nth-child(5) input').val(data_unit_name);
    ...
    $('tbody').on('keyup', ' tr td:nth-child(4) >input', function(event) {
        qnt=$(this).parents('tr').find('td:nth-child(4) input').val();
        // alert(qnt);
    });
    ...
    //             alert('Please input value quantity');
    ...
    //             e.preventDefault();
    //         }
    //         }else if(name != -1 && qnt != 0 && unit!= -1 && mc != -1){
    //             $('#form').submit();
    //         }
    //     });
</script>
