...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <h1 style="font-family:'Khmer OS';"><i class="fa fa-fw fa-map-marker"></i> តារាងឈ្មោះកម្មករ (ការដ្ឋាន ឫទ្ធីកៅស៊ូ)</h1>
        </div>
    </div>
    <br>
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active">
            <a href="#activity" data-toggle="tab">តារាងឈ្មោះកម្មករ</a>
        </li>
        <li role="presentation">
            <a href="#timeline" data-toggle="tab">តារាងព័ត៌មានកម្មករ</a>
        </li>
        <li role="presentation">
            <a href="#timeline" data-toggle="tab">តារាងចំនួនជ័រកៅស៊ូ</a>
        </li>
        <li role="presentation">
            <a href="#timeline" data-toggle="tab">តារាងបង្កកអំបិល</a>
        </li>
        <li role="presentation">
            <a href="#timeline" data-toggle="tab">តារាងប្រើប្រាស់ភ្លើង</a>
        </li>
    </ul>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable dtr-inline collapsed" id="sample_1" role="grid" aria-describedby="sample_1_info">
                        <thead>
                            <tr role="row">
                                <th class="text-center">ល.រ</th>
                                <th class="text-center">លេខកាតបុគ្គលិក</th>
                                <th class="text-center">លេខបាំង</th>
                            ...
                            <?php
                                ...
                                $i = 0;
                                    ...
                                    $get_data2 = $connect->query("SELECT 
                                        A.*,right(A.empl_card_id,4) as num_block,B.po_name,B.po_note,C.dep_name,C.dep_id,D.sex_name,E.national_name
                                        FROM tbl_hr_employee_list AS A 
                                        LEFT JOIN tbl_hr_position_list AS B ON A.empl_position=B.po_id
                                        LEFT JOIN tbl_hr_department_sub AS C ON A.empl_department=C.dep_id
                                        left join tbl_hr_sex_list as D on A.empl_sex=D.sex_id
