                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <input name="txt_id_card" value="<?= $row_old_data->empl_card_id ?>" type="text" class="form-control" required=""  autocomplete="off" autofocus="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                        <label>Phone 2 : </label>
                                        <input type="text" value="<?= $row_old_data->empl_phone2 ?>" class="form-control" name="txt_phone2" required=""  autocomplete="off">
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <div class = "form-group col-xs-12">                                   
                                            <img src = "../../img/img_empl/<?= $row_old_data->empl_pic ?>" width = "300px" id="preview">
                                        </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <div class="form-group">
