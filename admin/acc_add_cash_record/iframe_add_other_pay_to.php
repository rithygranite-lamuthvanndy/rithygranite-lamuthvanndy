...
<?php
   ...
   if(isset($_POST['btn_submit'])){
        ...
        $v_phone = @$_POST['txt_phone_number'];
        $v_address = @$_POST['txt_address'];
        $v_email = @$_POST['txt_email'];
        $user_id=@$_SESSION['user']->user_id;

        $query_add = "INSERT INTO tbl_acc_other_pay_to_list (
                name,
                phone_number,
                address,
                note,
                 ...
                 <form action="#" method="post" enctype="multipart/form-data">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group form-md-line-input">
                                    <input type="text" class="form-control" name="txt_phone_number"> 
                                    <label>Phone :
                                        <span aria-required="true"></span>
                                    </label>
                                </div>
