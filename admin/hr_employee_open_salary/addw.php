                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <label>Depantment/ផ្នែក: </label>
                                    <input name="txt_dep" type="text" class="form-control"  required="" readonly="" placeholder="Auto Fill...">
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <a href="index_worker.php" class="btn red"><i class="fa fa-undo fa-fw"></i>Cancel</a>
                            </div>
                        </div>
                    </div>
                </form><br>
    ...
    $(document).ready(function () {
        $('select[name=txt_emp_id]').change(function () {
            ...
            $.ajax({url: 'ajx_get_salary_info.php?v_emp_id='+v_emp_id,success:function (result) {
                ...
                $('input[name=txt_dep]').val(myObj['empl_department']);
