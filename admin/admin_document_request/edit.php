...
<?php 
    if(isset($_POST['btn_submit'])){
        ...
        $query_update = "UPDATE `tbl_admin_document_request` 
            SET 
                docr_date_record='$v_dat_record',
                docr_request_name='$v_res_name',
                docr_title='$v_title',
                docr_description='$v_des',
                docr_department='$v_dep',
                docr_employee_check='$v_emp_chk'
            WHERE `docr_id`='$v_id'";
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" required name="txt_dat_record" type="text" data-provide="datepicker" data-date-format="yyyy-mm-dd" placeholder="date..." autocomplete="off" value="<?= $row_old_data->docr_date_record ?>">          
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="cbo_emp_chk" class="form-control" required="required">
                                        ...
                                        <?php 
                                            ...
                                            while ($row=mysqli_fetch_object($sql)) {
                                                if($row_old_data->docr_employee_check==$row->cnl_id)
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cbo_dep" class="form-control" required="required">
                                        ...
                                        <?php 
                                            ...
                                            while ($row=mysqli_fetch_object($sql)) {
                                                if($row_old_data->docr_department==$row->dep_id)
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="<?= $row_old_data->docr_request_name ?>" type="text" class="form-control" name="txt_res_name" placeholder=" " required="required" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label>Title:</label>
                                    <input value="<?= $row_old_data->docr_title ?>" type="text" class="form-control" name="txt_title" placeholder=" " required="required" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label>Description :</label>
                                    <textarea name="txt_des" id="inputTxt_des" class="form-control" rows="3"><?= $row_old_data->docr_description ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
