                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            while ($row_child=mysqli_fetch_object($v_result_child)) {
                                                ...
                                                echo '<tr>';
                                                    echo '<td>
                                                                <input type="text" value="'.$row_child->stpron_code.'" name="txt_pro_code[]" id="inputTxt_acc_no" class="form-control" readonly="" style="width: 100%;">
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input type="text" name="txt_amo[]" value="'.$row_child->total_amo.'" readonly="" id="inputTxt_acc_no" class="form-control" style="width: 100%;">
                                                            </td>
...
<script type="text/javascript">
    ...
    $('#btn_save').on('click', function(e)
    {
        ...
        for(i=0;i<tr_am;i++)
        {
            ...
            else if(pr_vn==0|| pr_vn=='')
            {
                alert('Please input price of VIETNAM!');
