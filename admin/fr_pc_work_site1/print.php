...
<body  onload="window.print();" id="content">
    ...
    <?php 
        if (isset($_GET['print_id'])) {
            ...
            $sql_main=$connect->query("SELECT A.*,B.fpt_name
...
<table width="100%">
  ...
  <tr>
    ...
    <td colspan="3" style="font-size: 14px!important; font-family: 'Times New Roman';text-align: left;">27-03-2021</td>
  ...
  <tr>
    ...
    <td colspan="14" style="border-top: 1px solid black;border-right: 1px solid black;font-size: 11px!important; font-family: 'Khmer OS Niroth';"></td>
