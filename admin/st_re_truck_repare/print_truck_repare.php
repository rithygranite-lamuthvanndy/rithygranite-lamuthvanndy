...
<body>
    ...
    <center>
        <?php
            ...
            echo '<h3>របាយការណ៍សម្ភារៈប្រើប្រាស់ក្នុងការជួសជុល ប្រចាំខែ' . date('d/m/Y', strtotime($date1)) . ' - ' . date('d/m/Y', strtotime($date2)) . '</h3>';
      
        ?>
        <h4>Báo Cáo vật tư sử dụng trong sửa chữa của tháng</h4>
        <br>
    </center>
  </div>
    <div class="main_border">
    ...
    ?>
                            ...
                            <?php
                             if($track_name !=$rows->name) {
                                ...
                                <td style="text-align:left !important;"  colspan="9" class="">'.numberToRomanRepresentation(++$loop_i).' '.$rows->name.'</td>
                                       </tr>';
