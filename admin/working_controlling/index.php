...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-fw fa-map-marker"></i> Controlling</h2>
        </div>
    </div>
    <br>
    <div class="row">
            ...
            <table class="table table-striped table-bordered table-hover dataTable dtr-inline collapsed" id="sample_1" role="grid" aria-describedby="sample_1_info" style="width: 1180px;">
                <thead>
                    <tr role="row" class="text-center">
                        ...
                        <th>Employee</th>
                        <th>Approved by</th>
                        <th class="text-danger">Check Controlling</th>
                        <th>Note</th>
                        <th>User</th>
                        <th>Date_Audit</th>
                    ...
                    <?php
                        ...
                        if(isset($_POST['btn_search'])){
                            ...
                            if($v_topic != "" AND $v_employee == ""){
                                ...
                                LEFT JOIN tbl_working_check_controlling AS WCC ON A.wfpl_check_controlling=WCC.wfcc_id
                                LEFT JOIN tbl_user AS U ON A.user_id=U.user_id
                                WHERE wfpl_date_record BETWEEN '$v_from' AND '$v_to' AND A.wfpl_employee='$v_employee'
                        ...
                        while ($row = mysqli_fetch_object($get_data)) {
                            echo '<tr>';
                                ...
                                echo '<td>'.$row_apb_name->emp_name.'</td>';
                                echo '<td class="text-center text-danger">
                                        <a href="check_controlling.php?sent_id='.$row->wfpl_id.'">
