...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-fw fa-map-marker"></i> Stock Check List</h2>
        </div>
    </div>
    <br>
    <br>
            ...
            <table class="table table-striped table-bordered table-hover dataTable dtr-inline collapsed" id="sample_1" role="grid" aria-describedby="sample_1_info" style="width: 1180px;">
                <thead>
                    <tr role="row" class="text-center">
                        ...
                        <th>Stock Check Date</th>
                        <th>Stock Check Comment</th>
                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_object($get_data)) {
                            echo '<tr>';
                                ...
                                echo check_list($row->req_id,$row->st_check_by);
                                echo    '</td>';
                                ...
                                $sql=$connect->query("SELECT * 
                                    ...
                                    LEFT JOIN tbl_acc_check_name_list AS B ON A.st_check_by=B.chn_id WHERE req_id='$row->req_id'");
                                $row_1=mysqli_fetch_object($sql);
                                echo '<td>'.$row_1->chn_name.'</td>';
                                echo '<td>'.$row->st_check_date.'</td>';
                                echo '<td>'.$row->st_check_comment.'</td>';
                            echo '</tr>';
                        }
                    ?>
                </tbody>
