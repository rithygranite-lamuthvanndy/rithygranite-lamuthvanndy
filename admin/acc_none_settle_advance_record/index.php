...
if(isset($_POST['btn_search'])){
    ...
    $get_data = $connect->query("SELECT A.*,
        SUM(settle_in) AS totalIn,
        SUM(settle_out) AS totalOut
        FROM tbl_acc_none_settle_advance AS A
        RIGHT JOIN tbl_acc_none_settle_advance_detail AS B ON A.id=B.main_id 
...
if(isset($_POST['txt_new_row'])){
    $_SESSION['new_row_acc_none_settle_advance_record']=$_POST['txt_new_row'];
}
...
<div class="portlet light bordered">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation" class="active">
            <a href="#">Settle Advance Record</a>
        </li>
    </ul>
    <div class="">
                    ...
                    <li >
                        <a class="tool-action">
                            <i class="icon-printer"></i>
                                Custom Row Page
                                <input name="txt_new_row" form="form" value="<?= (@$_SESSION['new_row_acc_none_settle_advance_record'])?(@$_SESSION['new_row_acc_none_settle_advance_record']):0 ?>" class="form-control" type="number" onsubmit="this.form,submit()" value="0">
                        </a>
                    </li>
                </ul>
            </div> 
                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_object($get_data)) {
                            echo '<tr>';
                                ...
                                echo '<td class="text-center">'.number_format($row->totalIn,2).'</td>';
                                echo '<td class="text-center">'.number_format($row->totalOut,2).'</td>';
