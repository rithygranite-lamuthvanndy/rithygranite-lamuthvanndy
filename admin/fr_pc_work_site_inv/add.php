    ...
    <form action="#" method="post" accept-charset="utf-8">
        <div class="row" style="padding: 0 15px;">
            ...
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                ...
                <div class="form-group">
                    <label>Type :</label>
                    <input type="text" name="txt_number1" class="form-control" autocomplete="off" readonly="">
                </div>
                <div class="form-group">
                    <label>Number Phone :</label>
                    <input type="text" name="txt_number2" class="form-control" autocomplete="off" readonly="">
                </div>
            </div>

            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 pull-right"><br>
                <div class="form-group">
                    <label>Note :
                ...
                <table id="myTable" class="table table-bordered myFormDetail_ns">
                    ...
                    <tbody>
                        <tr class="my_form_base" style="background: red; display: none;">
                            ...
                            <td>
                                <!--<input type="text" name="txt_frpc_id[]" class="form-control" >
                                <select class="form-control" id="unit_name" name="txt_frpc_id[]" required="" autocomplete="off">
                                    <option value="">==Please Choose and Select==</option>
                                    <?php
                                ...
                                <select class="form-control" id="unit_name" name="txt_frpc_id[]" >
                                    <option value="">==Please Choose and Select==</option>
                                    <?php
                                    $v_select = $connect->query("SELECT * FROM tbl_acc_request_wordsite ORDER BY reqw_id ASC");
                                    while ($row_data = mysqli_fetch_object($v_select)) {
