        ...
        <div class="row">
            <div class="col-xs-1">
                <div class="caption font-dark">
                    <a href="index.php?v_start=<?php echo @$_GET['v_start']; ?>&v_end=<?php echo @$_GET['v_end']; ?>&check=1" id="sample_editable_1_new" class="btn red"> 
    ...
    <div class="portlet-body">
        <div class="bs-example" data-example-id="bordered-table">
            <table class="table table-bordered table-hover">
                <thead>
                    <tr style=" background: #DDEBF7 !important;">
                       <th class="text-center">N&deg;</th>
                       <th class="text-center">Item Name KH</th>
                       <th class="text-center">Item Name VN</th>
                       <th class="text-center">សំរាប់-Dành cho</th>
                    ...
                    <?php
                        ...
                        while ($row_select = mysqli_fetch_object($get_data)) {
                            echo '<tr>';
                                ...
                                echo '<td class="text-center">'.$row_select->rei_type.'</td>';
                                echo '<td class="text-center">'.$row_select->for_area.'</td>';
                                echo '<td class="text-center">'.$row_select->rei_size.'</td>';
                ...
                <tfoot>
                    ...
                    <th class="text-center" style="background:#e7ecf1;"><strong><?= number_format($total_amo,3) ?> $</strong></th>
                </tfoot>
            </table>
