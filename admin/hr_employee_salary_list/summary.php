        ...
        <table class="table table-striped table-bordered table-hover dataTable dtr-inline" id="sample_1" role="grid" aria-describedby="sample_1_info">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_object($get_data)) {
                    ...
                    echo '<a href="#modal" onclick="set_iframe_out_type(' . $row->id . ')"  data-toggle="modal" class="btn btn-xs btn-primary" title="Stock Out Type">Update Stock Out ( ' . $row->in_count . ' / ' . $row->out_count . ' )</a> ';
                    echo '</td>';
