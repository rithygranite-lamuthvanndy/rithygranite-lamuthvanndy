            ...
            <div class="panel-body">
                <form action="#" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <table id="myTable" class="table table-bordered table-responsive">
                        <thead>
                            <tr>
                                <th class="text-center" style="width: 15%;">តំបន់ <br> Khu<br>
                                ...
                                <th class="text-center" style="width: 15%;">ជាន់ <br> Tầng<br>
                        ...
                        <tbody>
                            <?php 
                                ...
                                while ($row_old_child=mysqli_fetch_object($sql_child)) {
                                    ...
                                    echo '<tr>';
                                        ...
                                        echo '<td>
                                                <select class="form-control myselect2" name="cbo_floor[]">
                                                    <option value="">=== Please Choose and Select ===</option>';
                                                        $v_select = $connect->query("SELECT * FROM tbl_inv_floor_list ORDER BY name");
                                                        while ($row_data = mysqli_fetch_object($v_select)) {
                                                            if($row_old_child->floor_id==$row_data->id)
                                                                echo '<option selected value="'.$row_data->id.'">'.$row_data->name.'</option>';
                                                            else
                                                                echo '<option value="'.$row_data->id.'">'.$row_data->name.'</option>';
                                                        }
                                        ...
                                        echo '<td>
                                                <input value='.$row_old_child->block_code.' type="text" name="txt_block_code[]" class="form-control" readonly="">
                                            </td>';
                                        echo '<td>
                            ...
                            <tr class="my_form_base" style="background: red; display: none;">
                                ...
                                <td>
                                    <input type="text" name="txt_block_code[]" class="form-control" readonly="">
                                </td>
                                <td>
