...
<?php 
    if(isset($_POST['btn_submit'])){
        ...
        if($v_file["name"] != ""){
            ...
            if(move_uploaded_file($v_file["tmp_name"], "../../file/file_document_done/".$new_name)){
                if(file_exists("../../file/file_document_done/".$v_old_file)){
                    unlink("../../file/file_document_done/".$v_old_file);
                }
            }else{
                $new_name = $v_old_file;
            }
