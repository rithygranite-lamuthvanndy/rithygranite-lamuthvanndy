...
if(isset($_POST['btn_save_sup_name'])){
    ...
    $v_code = @$_POST['txt_item_code'];
    $v_item_en = @$_POST['txt_name_en'];
    $v_item_kh = @$_POST['txt_name_kh'];
    $v_stock_type = @$_POST['txt_stock_type'];
    $v_price_sell = @$_POST['txt_price_sell'];
    $v_note = @$_POST['txt_note'];
    $v_user_id = @$_SESSION['user']->user_id;
    

    $query_add = "INSERT INTO tbl_st_item_name (
            stite_date_record,
            stite_code,
            stite_item_en,
            stite_item_kh,
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="txt_item_code" required=""  autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <label>Name EN : </label>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <label>Type : </label>
                                        <select type="text" class="form-control myselect2" name="txt_stock_type" required="" autocomplete="off" style="width: 100%;">
                                            <option value="">=== Select and choose===</option>
                                            <?php 
                                                $get_select=$connect->query("SELECT * FROM tbl_st_stock_type ORDER BY sttyp_name ASC");
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="txt_price_sell" required="" autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <label>Note : </label>
