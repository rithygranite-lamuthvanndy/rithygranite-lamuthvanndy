    ...
    <div class="main_border">
        <?php 
            if($_SESSION['status']==1){
                echo '<h3>តារាងកែប្រែស្ដុកសំភារៈផ្កត់ផ្គង់ក្នុងរណ្ដៅប្រចាំថ្ងៃ</h3>';
            }
            else if($_SESSION['status']==2){
                echo '<h3>តារាងកែប្រែស្ដុកសំភារៈផ្កត់ផ្គង់រោងចក្រម្ដងម្កាល</h3>';
            }
            else {
                echo '<h3>តារាងសម្ភារៈជួសជុលម្ដងម្កាល</h3>';
            }
         ?>
