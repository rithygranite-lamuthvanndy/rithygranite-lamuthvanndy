                        ...
                        <div class="row" style="overflow-x: scroll;">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive">
                                <table id="myTable" class="table table-bordered myFormDetail_ns" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th class="text-center" style="width: 50px;">កូដ</th>
                                            ...
                                            <th class="text-center" style="width: 20%;">តំបន់</th>
                                    ...
                                    <tbody style="overflow-x: scroll;">
                                        <tr class="my_form_base" style="background: red;display: none; overflow-x: scroll;">
                                            <td>
...
<script type="text/javascript">
    ...
    $('#add_more').click(function(){ 
        ...
        // alert(tr_am);
        $('#myTable').find('tbody tr:eq('+(tr_am)+')').after('<tr data-row-id="'+(++index_row)+'">'+$('.my_form_base').html()+'</tr>');
        $('tr[data-row-id='+index_row+']').find('select').select2();
    ...
    $("tbody").on('change', 'tr td:nth-child(2) select', function () {
        ...
        $(this).parents('tr').find('td:first-child input').val(v_pro_code);
         ...
         data_unit_name=$(this).find('option:selected').attr('data_unit_name'); 
            ...
            $(this).parents('tr').find('td:nth-child(10) input').val(data_unit_id);
