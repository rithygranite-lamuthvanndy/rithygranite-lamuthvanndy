...
$objPHPExcel->getActiveSheet()->setCellValue('E' . 1, 'តារាងបញ្ចេញស្ដុកប្រចាំថ្ងៃ'.' '.date('d/m/Y', strtotime($v_date_start)).'-'. date('d/m/Y', strtotime($v_date_end)));
$objPHPExcel->getActiveSheet()->setCellValue('E' . 2, 'Bảng Xuất Kho Hàng Ngày');
// Header
