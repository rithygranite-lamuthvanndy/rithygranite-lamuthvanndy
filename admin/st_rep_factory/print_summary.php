...
<?php
   ...
   global $connect; 
                ...
                WHERE A.stpron_material_type='2'
                HAVING 
...
while ($row1 = mysqli_fetch_object($get_data1)) {
 ...
 $v_sql2 = "SELECT * FROM tbl_st_category_list WHERE material_type_id='2' AND stca_id='$cate_min_id' ";
...
<body>
    <div class="main_border">
        <?php
            ...
            echo '<h3>របាយការណ៍សម្ភារៈផលិតក្នុងរោងចក្រ' . date('d/m/Y', strtotime($v_date_start)) . ' - ' . date('d/m/Y', strtotime($v_date_end)) . '</h3>';
      
        ?>
        <h4>BÁO CÁO VẬT TỪ SỬ DỤNG TRONG NHÀ MÁY</h4>
        <br>
        <!-- Table Decription -->
        <table>
            <thead>
...
while ($row = mysqli_fetch_object($get_data)) {
                ...
                $i = 0;
                $v_sql = "SELECT * FROM tbl_st_category_list WHERE material_type_id='2'";
