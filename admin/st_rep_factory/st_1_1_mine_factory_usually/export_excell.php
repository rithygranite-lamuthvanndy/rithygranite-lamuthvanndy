...
$objPHPExcel->getActiveSheet()->setCellValue('E' . 1, 'សម្ភារប្រើប្រាស់នៅក្នុងរោងចក្រ'.' '.date('d/m/Y', strtotime($v_date_start)).'-'. date('d/m/Y', strtotime($v_date_end)));
$objPHPExcel->getActiveSheet()->setCellValue('E' . 2, 'VẬT TƯ SỬ DỤNG TRONG NHÀ MÁY - THÁNG');
// Header
