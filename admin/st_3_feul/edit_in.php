                                ...
                                <table id="myTable" class="table table-bordered" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="width: 14%;">សំគាល់/ឯកតា</th>
                                            <th class="text-center" style="width: 14%;">តម្លៃ/L</th>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center" style="width: 7%;">Ghi Chú/Đơn vị</th>
                                            <th class="text-center" style="width: 15%;">Giá USD/L</th>
                                    ...
                                    <tbody>
                                        <?php 
                                            $v_sql_child="SELECT *,
                                                        (A.in_qty*A.in_price_dollar) AS total_amo,C.stpron_code
                                            ...
                                            while ($row_child=mysqli_fetch_object($v_result_child)) {
                                                ...
                                                echo '<tr>';
                                                    echo '<td>
                                                        ...
                                                        <td>
                                                            <input value="'.$row_child->in_qty.'" type="number" step="1" name="txt_qty[]" class="form-control" value="0">
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <input value="'.$row_child->in_price_dollar.'"  type="number" step="0.001" name="txt_price_dollar[]" class="form-control" value="0">
                                                        </td>
                                                        <td>
                                                            <input  value="'.number_format($row_child->total_amo,2).'" type="text" name="txt_amo[]" value="0" readonly="" id="inputTxt_acc_no" class="form-control">
                                                        </td>
...
<script type="text/javascript">
    ...
    $('tbody').on('keyup', 'tr td:nth-child(3) >input,tr td:nth-child(5) >input,tr td:nth-child(6) >input', function(event) {
        ...
        let v_price_dollar=$(this).parents('tr').find('td:nth-child(5) input').val();
        let v_amo=(v_price_dollar*v_qty);
        $(this).parents('tr').find('td:nth-child(6) input').val(v_amo.toFixed(2));
        totalAmount();
    });
    ...
    //         var l = $('#myTable').find('tbody tr:eq('+i+') td:eq(4) input').val();
    //         if(name==0||name=='')
    //         {
