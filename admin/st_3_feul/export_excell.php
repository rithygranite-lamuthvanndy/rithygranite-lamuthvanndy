...
$objPHPExcel->getActiveSheet()->setCellValue('E' . 1, 'របាយការណ៍ស្ដុកប្រេង'.' '.date('d/m/Y', strtotime($v_date_start)).'-'. date('d/m/Y', strtotime($v_date_end)));
$objPHPExcel->getActiveSheet()->setCellValue('E' . 2, 'Bào Cáo Kho Dầu - THÁNG'.' '.date('d/m/Y', strtotime($v_date_start)).'-'. date('d/m/Y', strtotime($v_date_end)));
// Header
