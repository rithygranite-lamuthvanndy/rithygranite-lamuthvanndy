        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">
                    ...
                    Edit Stock Adjustment <?= $_SESSION['title'] ?>
                </h3>
            </div>
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label>Note : </label>
                                    <textarea type="text" class="form-control" name="txt_note" rows="1" autocomplete="off"><?= $row_old_data->stsadj_note ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12 text-center">
                                    ...
                                    <button type="submit" name="btn_save_adjust" id="btn_save" class="btn blue"><i class="fa fa-save fa-fw"></i>Save</button>
