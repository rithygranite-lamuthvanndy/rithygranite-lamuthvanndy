                                            ...
                                            echo '</select>
                                                ...
                                                <td>
                                                        ...
                                                        <option value="">=== Select ===</option>';
                                                            ...
                                                            while ($row_data = mysqli_fetch_object($v_select)) {
                                                                echo '<option ' . ($row_child->locaton_id == $row_data->stsup_id ? 'selected' : '') . ' value="' . $row_data->stsup_id . '">' . $row_data->stsup_name . '</option>';
                                                            }
                                                            echo '</select>
...
<script type="text/javascript">
    ...
    $('#add_more').click(function() {
        ...
        $('tr[data-row-id='+index_row+']').find('select').select2({width: 'auto'});
    });
    // setTimeout(function(){
    //     $('#add_more').click();      
    // },1000);
    ...
    //         var unit = $('#myTable').find('tbody tr:eq('+i+') td:eq(6) select').val();
    ...
    //             $('#myTable').find('tbody tr:eq('+i+') td:eq(6) select').focus();
    //             e.preventDefault();
    //             break; 
    //         }
    //         else if(mc==0|| mc=='')
    ...
    //             $('#myTable').find('tbody tr:eq('+i+') td:eq(7) select').focus();
    //             e.preventDefault();
    //             break; 
    //         }
    //     }
