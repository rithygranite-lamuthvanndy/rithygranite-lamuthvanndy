...
<?php 
    if(isset($_POST['btn_submit'])){
        ...
        $query_update = "UPDATE `tbl_st_product_type_list` 
            SET 
...
// get old data 
    ...
    $old_data = $connect->query("SELECT * FROM tbl_st_product_type_list WHERE id='$edit_id'");
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label>Note : </label>
                                    <textarea type="text" class="form-control" name="txt_note" autocomplete="off"><?= $row_old_data->note ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
