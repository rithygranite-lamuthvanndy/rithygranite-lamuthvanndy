<?php 
    $menu_active =140;
    $left_active =0;
    $layout_title = "Create Product Set";
...
<?php 
    if(isset($_POST['btn_submit'])){
        ...
        $query_add = "INSERT INTO tbl_st_product_set (
                stpset_date_record,
                stpset_name_kh,
                stpset_name_vn,
                stpset_employee,
        ...
        $sql="INSERT INTO tbl_st_product_set_detail
                (
                stpset_detail_id,
                pro_id,
                qty,
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select type="text" class="form-control myselect2" name="cbo_employee" autocomplete="off">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="txt_item_kh"   autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label>Item Name VN *: </label>
                                    <input type="text" class="form-control" name="txt_item_vn"   autocomplete="off">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="form-group">
                                ...
                                <table id="myTable" class="table table-bordered" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="width: 40%;">Product Name
                                    ...
                                    <tbody>
                                        <tr class="my_form_base" style="background: red; display: none;">
                                            ...
                                            <td>
                                                <input onkeypress="return intOnly(event)" type="number" step="1" name="txt_qty[]" class="form-control" value="0">
                                            </td>
                                            <td>
