...
<div class="portlet light bordered">
    ...
    <div class="">
        <div class="caption font-dark">
            <a href="nfa_add.php?view=<?= @$_GET['view'] ?>" id="sample_editable_1_new" class="btn green"> Add New
                        ...
                        while ($row = mysqli_fetch_object($get_data)) {
                            echo '<tr>';
                                ...
                                echo '<td class="text-center">';
                                    echo '<a href="nfa_edit.php?edit_id='.$row->id.'&view='.@$_GET['view'].'" class="btn btn-xs btn-warning" title="edit"><i class="fa fa-edit"></i></a> ';
