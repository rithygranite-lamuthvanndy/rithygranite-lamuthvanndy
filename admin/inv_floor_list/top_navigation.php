...
<div class="page-actions">
    ...
    <li class="btn-group">
        <a href="../com_company/index.php" class="btn red-haze btn-sm <?= (@$menu_active==11)?("active"):("") ?>">Company</a>
    </li>
    <li class="btn-group">
    ...
    <li class="btn-group">
        <a href="../st_stock/index.php" class="btn red-haze btn-sm <?= (@$menu_active==140)?("active"):("") ?>">Stock</a>
    </li>
    <li class="btn-group">
    ...
    <div class="btn-group">
        ...
        <!-- Menu For Developer -->
        <?php if($_SESSION['user']->user_position==15){?>
            <li class="btn-group">
