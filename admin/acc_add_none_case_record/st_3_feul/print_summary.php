...
<body>
    <div class="main_border">
        <h3>របាយការណ៍ស្ដុកប្រេង <?= date('d/m/Y', strtotime($v_date_start)) . ' - ' . date('d/m/Y', strtotime($v_date_end)) ?></h3>
        <h4>Bào Cáo Kho Dầu - THÁNG <?= date('d/m/Y', strtotime($v_date_start)) . ' - ' . date('d/m/Y', strtotime($v_date_end)) ?></h4>
        <br>
        <!-- Table Decription -->
        <table>
            <tbody>
