                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group " placeholder="date end">
                                    <label>PO No :  </label>
                                    <input type="text" onkeyup="changepono()" class="form-control" name="txt_number"  id="txt_number" value="calculating">
                    ...
                    <table id="myTable" class="table table-bordered table-responsive">
                        ...
                        <tbody>
                            <tr class="my_form_base" style="background: red; display: none;">
                                ...
                                <td>
                                    <input type="number" name="txt_pcs_slab[]" onchange="changeHeight(this)" onkeyup="changeHeight(this)" class="form-control">
                                </td>
                                <td>
    ...
    $(document).ready(function(){
        ...
        $('select[name="cbo_customer"]').change(function () {
            ...
            $.ajax({url: 'ajax_get_rec_info.php',
                data:'data='+myArr,type:'POST',async:false,success:function (result) {
               last_result=result;
           }});
