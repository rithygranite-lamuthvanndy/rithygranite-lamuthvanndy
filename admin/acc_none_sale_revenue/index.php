...
if(isset($_POST['btn_search'])){
    ...
    $get_data = $connect->query("SELECT A.*,cussi_name,
...
if(isset($_POST['txt_new_row'])){
    $_SESSION['new_row_acc_none_sale_revenue']=$_POST['txt_new_row'];
}
...
<div class="portlet light bordered">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active">
            <a href="#">Sale Revenue</a>
        </li>
        <li role="presentation">
            <a href="../acc_none_bill_supplier/">Bill Supplier</a>
        </li>
        <li role="presentation">
                    ...
                    <li >
                        <a class="tool-action">
                            <i class="icon-printer"></i>
                                Custom Row Page
                                <input name="txt_new_row" form="form" value="<?= (@$_SESSION['new_row_acc_none_sale_revenue'])?(@$_SESSION['new_row_acc_none_sale_revenue']):0 ?>" class="form-control" type="number" onsubmit="this.form,submit()" value="0">
                        </a>
                    </li>
                </ul>
            </div> 
            ...
            <table class="table table-striped table-bordered table-hover dataTable dtr-inline" id="sample_1" role="grid" aria-describedby="sample_1_info" style="width: 1180px;">
                <thead>
                    <tr role="row" class="text-center">
                        ...
                        <th class="text-center">Total Mater </th>
                        <th class="text-center">Total Amount</th>
                        <th class="text-center">Total Discount</th>
                        <th class="text-center">Grand Total</th>
                        <th style="min-width: 100px;" class="text-center">Action <i class="fa fa-cog fa-spin"></i> <input type="checkbox" name="check_all"></th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                        ...
                        while ($row = mysqli_fetch_object($get_data)) {
                            echo '<tr>';
                                ...
                                echo '<td class="text-center">'.number_format($row->total_slab,2).'</td>';
                                echo '<td class="text-center">'.number_format($row->total_mater,2).'</td>';
