...
<?php 
    if(isset($_POST['btn_submit'])){
        ...
        $v_photo_id = (!@$_SESSION['saved_image_name']) ?: 'blank.png';
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <select name="txt_dep_id" id="inputCbo_position" class="form-control myselect2" required="required">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12" style="padding-left: 0px;">
                                        ...
                                        <img width="150px;" src="../../img/img_fix_asset/<?= $row_old_data->photo_id ?>" alt="Blank">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <input name="txt_cost" value="<?= $row_old_data->physical_fa_cost ?>" type="text" class="form-control" required=""  autocomplete="off" autofocus="">
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                        <label>Narrative/ Remarks : </label>
                                        <input name="txt_na_re" value="<?= $row_old_data->narrative_remarks ?>" type="text" class="form-control" required=""  autocomplete="off" autofocus="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="txt_location" value="<?= $row_old_data->fix_asset_location ?>" type="text" class="form-control" required=""  autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-lg-12">
