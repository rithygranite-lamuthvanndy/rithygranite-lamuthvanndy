                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                    ...
                                    <?php 
                                        $sql=$connect->query("SELECT * FROM tbl_fr_pc_type_list ORDER BY fpt_id");
                                        while ($row=mysqli_fetch_object($sql)) {
                                            if($row_old_data->frpc_type==$row->fpt_id)
                                                echo '<option SELECTED data_code="'.$row->fpt_code.'" value="'.$row->fpt_id.'">'.$row->fpt_code.' :: '.$row->fpt_name.'</option>';
                                            else
                                                echo '<option data_code="'.$row->fpt_code.'" value="'.$row->fpt_id.'">'.$row->fpt_code.' :: '.$row->fpt_name.'</option>';
                                        }
                                     ?>
                                </select>
                            </div>
