...
<div class="portlet light bordered">
    ...
    <form action="save_pur_confirm.php" method="POST" role="form">
        <input type="hidden" value="<?= $row_old_data->pur_id ?>" name="txt_main_id">
        <!-- <button type="submit" name="btn_prin" class="btn btn-warning"><i class="fa fa-print"></i> Print</button> -->
        <button type="submit" name="btnUpdate" class="btn btn-primary"><i class="fa fa-save"></i> Update</button>
        <br>
        <br>
        <table class="table table-bordered">
            <thead>
                <tr>
                    <th colspan="3" style="background: #E2EFDA;text-align: center;">Purchase Request_Information</th>
                </tr>
                <tr>
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>1/ Confirmed Date :</label>
                                 <input type="text" data-provide="datepicker" data-date-format="yyyy-mm-dd" value="<?= $row_old_data->confirm_date; ?>" name="txt_confirm_date" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>6/ Approved by:</label>
                                 <input readonly="" id="txt_app_name" type="text"  value="<?php echo $row_old_data->apn_name; ?>" name="txt_6_app_by" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                        ...
                        <div class="pull-left">
                            ...
                            ORDER BY A.req_id DESC");
                                        ...
                                        while ($row_select=mysqli_fetch_object($v_select)) {
                                            if ($row_old_data->req_no == $row_select->req_id) {
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>7/ Requested Amount:</label>
                                 <input  type="text" id="txt_request_amount"  value="<?php echo $row_old_data->amount_request; ?>" name="txt_request_amount" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>3/ Department of RGC:</label>
                                 <input type="text" readonly="" id="txt_department"  value="<?php echo $row_old_data->dep_name; ?>" name="txt_3_dep_of_rgc" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>8/ Location:</label>
                                 <input type="text"  value="<?php echo $row_old_data->location; ?>" name="location" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>4/ Type of Request:</label>
                                 <input type="text" id="txt_type_request" readonly="" value="<?php echo $row_old_data->typr_name; ?>" name="txt_4_typ_of_req" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                            ...
                            ORDER BY empl_id DESC");
                                        while ($row_select=mysqli_fetch_object($v_select)) {
                                             ...
                                             if ($row_old_data->buyer_id == $row_select->empl_id) {
                                                 ...
                                                 echo '<option selected value="'.$row_select->empl_id.'">['.$row_select->empl_emloyee_en.'] ['.$row_select->empl_emloyee_kh.']</option>';
                                             }
                                             else {
                ...
                <tr>
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>5/ Requested by:</label>
                                 <input readonly="" id="txt_request_by" type="text" value="<?php echo $row_old_data->res_name; ?>" name="txt_5_res_by" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                    ...
                    <td>
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>10/ Note:</label>
                                 <textarea name="txt_note" class="form-control"><?php echo $row_old_data->note; ?></textarea>
                            </div>
                        </div>
                        <div class="pull-right">
        ...
        <div class="row">
                       ...
                       <select name="txt_user_id" class="form-control myselect2">
                            ...
                            ORDER BY user_name DESC");
                                        while ($row_select=mysqli_fetch_object($v_select)) {
                                            ...
                                            if ($row_old_data->name_id == $row_select->user_id) {
                                                 echo '<option selected value="'.$row_select->user_id.'">['.$row_select->user_name.'] ['.$row_select->user_phone_number.']</option>';
                                            }
                                            else {
            ...
            <div class="col-xs-8">
                <div class="form-group">
                    ...
                    <textarea rows="12" type="text" class="form-control" name="txt_des" rows="5" autocomplete="off"><?php echo $row_old_data->description; ?></textarea>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <input  <?php if($row_old_data->ch_1_1=="1") {echo "checked";} ?> type="checkbox" name="txt_ch_1_1" value="1" 
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>1/ Received Date:</label>
                                 <input type="text" data-provide="datepicker" data-date-format="yyyy-mm-dd" value="<?php echo $row_old_data->txt_1; ?>" name="txt_1" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                ...
                <tr >
                   ...
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <input  <?php if($row_old_data->ch_1_2=="1") {echo "checked";} ?> type="checkbox"  name="txt_ch_1_2" value="1">2/ រូបភាព
                                    <span></span>
                                </label>
                            </div>
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>2/ Received Amount:</label>
                                 <input type="text"  value="<?php echo $row_old_data->txt_2; ?>" name="txt_2" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                ...
                <tr>
                   ...
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <input  <?php if($row_old_data->ch_1_3=="1") {echo "checked";} ?> type="checkbox"  name="txt_ch_1_3" value="1">3/ កំណត់ហេតុ ឬមូលហេតុនៃការជួសជុល (បំពេញក្នុងសំណើរ)
                                    <span></span>
                                </label>
                            </div>
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>3/ Actual Expense:</label>
                                 <input type="text"  value="<?php echo $row_old_data->txt_3; ?>" name="txt_3" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                  ...
                  <td rowspan="5" style="vertical-align: middle !important;">from $201 - $300</td>
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <input  <?php if($row_old_data->ch_2_1=="1") {echo "checked";} ?> type="checkbox"  name="txt_ch_2_1" value="1">1/ ការឯកភាពពីគណៈគ្រប់គ្រង
                                    <span></span>
                                </label>
                            </div>
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>4/ Cash Settlement:</label>
                                 <input type="text"  value="<?php echo $row_old_data->txt_4; ?>" name="txt_4" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                ...
                <tr>
                   ...
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <input  <?php if($row_old_data->ch_2_2=="1") {echo "checked";} ?> type="checkbox"  name="txt_ch_2_2" value="1">2/ រូបភាព
                                    <span></span>
                                </label>
                            </div>
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>5/ Cash Settled by:</label>
                                 <input type="text"  value="<?php echo $row_old_data->txt_5; ?>" name="txt_5" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                ...
                <tr>
                   ...
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <input  <?php if($row_old_data->ch_2_3=="1") {echo "checked";} ?> type="checkbox"  name="txt_ch_2_3" value="1">3/ កំណត់ហេតុ ឬមូលហេតុនៃការជួសជុល (បំពេញក្នុងសំណើរ)
                                    <span></span>
                                </label>
                            </div>
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>6/ Purchsed Date :</label>
                                 <input type="text"  data-provide="datepicker" data-date-format="yyyy-mm-dd" value="<?php echo $row_old_data->txt_6; ?>" name="txt_6" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                ...
                <tr>
                   ...
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <input  <?php if($row_old_data->ch_2_4=="1") {echo "checked";} ?> type="checkbox"  name="txt_ch_2_4" value="1">4/ រ.តាមដានចំណាយ, រ.ស្តុក, រ.ជួសជុលគ្រឿងចក្រ
                                    <span></span>
                                </label>
                            </div>
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>7/ Transferred Date:</label>
                                 <input type="text"  data-provide="datepicker" data-date-format="yyyy-mm-dd" value="<?php echo $row_old_data->txt_7; ?>" name="txt_7" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                  ...
                  <td rowspan="8" style="vertical-align: middle !important;">From $301 -$1000</td>
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <input  <?php if($row_old_data->ch_3_1=="1") {echo "checked";} ?> type="checkbox"  name="txt_ch_3_1" value="1">1/ ការឯកភាពពីគណៈគ្រប់គ្រង
                                    <span></span>
                                </label>
                            </div>
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>8/ Deliveried Date:</label>
                                 <input type="text"  data-provide="datepicker" data-date-format="yyyy-mm-dd" value="<?php echo $row_old_data->txt_8; ?>" name="txt_8" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                ...
                <tr>
                   ...
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <input  <?php if($row_old_data->ch_3_2=="1") {echo "checked";} ?> type="checkbox"  name="txt_ch_3_2" value="1">2/ រូបភាព
                                    <span></span>
                                </label>
                            </div>
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>9/ Supplier's Name:</label>
                                 <input type="text"  value="<?php echo $row_old_data->txt_9; ?>" name="txt_9" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                ...
                <tr>
                   ...
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <input  <?php if($row_old_data->ch_3_3=="1") {echo "checked";} ?> type="checkbox"  name="txt_ch_3_3" value="1">3/ កំណត់ហេតុ ឬមូលហេតុនៃការជួសជុល (បំពេញក្នុងសំណើរ
                                    <span></span>
                                </label>
                            </div>
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>10/ Phone Number:</label>
                                 <input type="text"  value="<?php echo $row_old_data->txt_10; ?>" name="txt_10" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                ...
                <tr>
                   ...
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <input  <?php if($row_old_data->ch_3_4=="1") {echo "checked";} ?> type="checkbox"  name="txt_ch_3_4" value="1">4/ រ.តាមដានចំណាយ, រ.ស្តុក, រ.ជួសជុលគ្រឿងចក្រ
                                    <span></span>
                                </label>
                            </div>
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>11/ Area Purchase:</label>
                                 <input type="text"  value="<?php echo $row_old_data->txt_11; ?>" name="txt_11" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                ...
                <tr>
                   ...
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <input  <?php if($row_old_data->ch_3_5=="1") {echo "checked";} ?> type="checkbox"  name="txt_ch_3_5" value="1">5/ សំភារៈធ្លាប់ទិញឫជួសជុលពីមុន
                                    <span></span>
                                </label>
                            </div>
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>12/ Site Received Date:</label>
                                 <input type="text" data-provide="datepicker" data-date-format="yyyy-mm-dd" value="<?php echo $row_old_data->txt_12; ?>" name="txt_12" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                ...
                <tr>
                   ...
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <input  <?php if($row_old_data->ch_3_6=="1") {echo "checked";} ?> type="checkbox"  name="txt_ch_3_6" value="1">6/ Quotation
                                    <span></span>
                                </label>
                            </div>
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>13/ Attachment:</label>
                                 <input type="text"  value="<?php echo $row_old_data->txt_13; ?>" name="txt_13" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
                 ...
                 <tr>
                   ...
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <input  <?php if($row_old_data->ch_3_7=="1") {echo "checked";} ?> type="checkbox"  name="txt_ch_3_7" value="1">7/ ផែនការប្រើប្រាស់សំភារៈផលិត
                                    <span></span>
                                </label>
                            </div>
                        ...
                        <div class="pull-left">
                            <div class="form-inline">
                                <label>14/ Stock In Slip:</label>
                                 <input type="text"  value="<?php echo $row_old_data->txt_14; ?>" name="txt_14" class="form-control">
                            </div>
                        </div>
                        <div class="pull-right">
        ...
        <div class="row">
            ...
            <div class="col-xs-3" class="text-center">
                ...
                <label>Date:</label>
                <input type="text" data-provide="datepicker" data-date-format="yyyy-mm-dd" value="<?php echo $row_old_data->review_ad_date; ?>" name="txt_review_admin_date" class="form-control">
                <br><br><br>
            </div>
            <div class="col-xs-1"></div>
            <div class="col-xs-3" class="text-center">
                ...
                <div style="border: 0.5px double black;"></div>
                <label>Date:</label>
                <input type="text" data-provide="datepicker" data-date-format="yyyy-mm-dd" value="<?php echo $row_old_data->review_fm_date; ?>" name="txt_review_fm_date" class="form-control">
                <br><br><br>
            </div>
            ...
            <div class="col-xs-3" class="text-center">
                ...
                <div style="border: 0.5px double black;"></div>
                <label>Date:</label>
                 <input type="text" data-provide="datepicker" data-date-format="yyyy-mm-dd" value="<?php echo $row_old_data->app_ceo_date; ?>" name="txt_app_ceo_date" class="form-control">
                <br><br><br>
            </div>
