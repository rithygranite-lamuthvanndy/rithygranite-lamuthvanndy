                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <img class="img_size" src="uncheck.png">1/ ការឯកភាពពីគណៈគ្រប់គ្រង
                ...
                <tr >
                   ...
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <img class="img_size" src="uncheck.png">2/ រូបភាព
                ...
                <tr>
                   ...
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <img class="img_size" src="uncheck.png">3/ កំណត់ហេតុ ឬមូលហេតុនៃការជួសជុល (បំពេញក្នុងសំណើរ)
                ...
                <tr>
                   ...
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <img class="img_size" src="uncheck.png">4/ រ.តាមដានចំណាយ, រ.ស្តុក, រ.ជួសជុលគ្រឿងចក្រ
                ...
                <tr>
                   ...
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <img class="img_size" src="uncheck.png">5/ សំភារៈធ្លាប់ទិញឫជួសជុលពីមុន
                ...
                <tr>
                   ...
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <img class="img_size" src="uncheck.png">6/ Quotation
                 ...
                 <tr>
                   ...
                   <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="mt-checkbox">
                                    <img class="img_size" src="uncheck.png">7/ ផែនការប្រើប្រាស់សំភារៈផលិត
