...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-fw fa-map-marker"></i> Account Manager Approved</h2>
        </div>
    </div>
    <br>
    <div class="">
                ...
                <tbody>
                    <?php
                        ...
                        $get_data = $connect->query("SELECT 
                            ...
                            LEFT JOIN tbl_acc_type_account AS TA ON A.accca_account_type=TA.accta_id  
                            ORDER BY accca_id DESC");
