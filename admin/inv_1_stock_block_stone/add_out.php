...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <?= @$sms; ?>
            <h2>
                <i class="fa fa-plus-circle fa-fw"></i>Stock Block Out
            </h2>
        </div>
    </div>
            ...
            <div class="panel-body">
                <form action="#" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" data-provide="datepicker" data-date-format="yyyy-mm-dd" class="form-control" required name="txt_date_record" value="<?= date('d-m-Y') ?>">
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
                                <div class="form-group">
                    ...
                    <table id="myTable" class="table table-bordered table-responsive">
                        <thead>
                            <tr>
                                <th class="text-center" style="width: 15%;">តំបន់ / Khu *<br>
                                ...
                                <th class="text-center" style="width: 15%;">ជាន់ / Tầng<br>
                        ...
                        <tbody>
                            <tr class="my_form_base" style="background: red; display: none;">
                                ...
                                <td>
                                    <select class="form-control" name="cbo_floor[]">
                                        <option value="">=== Please Choose and Select ===</option>
                                        <?php 
                                ...
                                <td>
                                    <select class="form-control" onchange="changeGradetype(this);" name="txt_block_code[]">
                                        <option value="">===  ===</option>
                                        <?php 
                                            $v1_select = $connect->query("SELECT * FROM tbl_inv_1_stock_block_stone_detail ORDER BY block_code");
                                            while ($row1_data = mysqli_fetch_object($v1_select)) {
                                                echo '<option value="'.$row1_data->id.'">'.$row1_data->block_code.'-l:'.$row1_data->length.'-w:'.$row1_data->width.'-h:'.$row1_data->height.'</option>';
                                            }
                                         ?>
                                    </select>
                                </td>
