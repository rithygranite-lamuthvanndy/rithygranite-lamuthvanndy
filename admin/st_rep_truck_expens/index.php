       ...
       if (!in_array($rows->id, $v_track_tmp)) {
                ...
                <div class="table_tr">
                    <tr>
                        ...
                        <td style='mso-number-format:"0\.00"' id="total_this_year<?php echo $rows->id; ?>"></td>
                        <?php
                          if($v_date_end >=date("$year-01-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="out_td<?php echo $rows->id; ?>01" class="t_y<?php echo $rows->id; ?>"></td>
                        <?php } ?>
                        <?php
                          if($v_date_end >=date("$year-02-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="out_td<?php echo $rows->id; ?>02" class="t_y<?php echo $rows->id; ?>"></td>
                        <?php } ?>
                        <?php
                          if($v_date_end >=date("$year-03-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="out_td<?php echo $rows->id; ?>03" class="t_y<?php echo $rows->id; ?>"></td>
                        <?php } ?>
                    <?php
                          if($v_date_end >=date("$year-04-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="out_td<?php echo $rows->id; ?>04" class="t_y<?php echo $rows->id; ?>"></td>
                        <?php } ?>
                        <?php
                          if($v_date_end >=date("$year-05-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="out_td<?php echo $rows->id; ?>05" class="t_y<?php echo $rows->id; ?>"></td>
                       <?php } ?>
                       <?php
                          if($v_date_end >=date("$year-06-01") 
                        ...
                        ?> 
                        <td style='mso-number-format:"0\.00"' id="out_td<?php echo $rows->id; ?>06" class="t_y<?php echo $rows->id; ?>"></td>
                        <?php } ?>
                    <?php
                          if($v_date_end >=date("$year-07-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="out_td<?php echo $rows->id; ?>07" class="t_y<?php echo $rows->id; ?>"></td>
                       <?php } ?>
                    <?php
                          if($v_date_end >=date("$year-08-01") 
                        ...
                        ?> 
                        <td style='mso-number-format:"0\.00"' id="out_td<?php echo $rows->id; ?>08" class="t_y<?php echo $rows->id; ?>"></td>
                     <?php } ?>
                     <?php
                          if($v_date_end >=date("$year-09-01") 
                        ...
                        ?>  
                        <td style='mso-number-format:"0\.00"' id="out_td<?php echo $rows->id; ?>09" class="t_y<?php echo $rows->id; ?>"></td>
                       <?php } ?>
                       <?php
                          if($v_date_end >=date("$year-10-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="out_td<?php echo $rows->id; ?>10" class="t_y<?php echo $rows->id; ?>"></td>
                        <?php } ?>
                    <?php
                          if($v_date_end >=date("$year-11-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="out_td<?php echo $rows->id; ?>11" class="t_y<?php echo $rows->id; ?>"></td>
                        <?php } ?>
                        <?php
                          if($v_date_end >=date("$year-12-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="out_td<?php echo $rows->id; ?>12" class="t_y<?php echo $rows->id; ?>"></td>
                    <?php } ?>
                    </tr>
                </div>
                    ...
                    <script type="text/javascript">
                        ...
                        var sum_out01 = 0;
                        var div_tr01 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var sum_out02 = 0;
                        var div_tr02 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var sum_out03 = 0;
                        var div_tr03 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var sum_out04 = 0;
                        var div_tr04 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var sum_out05 = 0;
                        var div_tr05 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var sum_out06 = 0;
                        var div_tr06 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var sum_out07 = 0;
                        var div_tr07 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var sum_out08 = 0;
                        var div_tr08 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var sum_out09 = 0;
                        var div_tr09 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var sum_out10 = 0;
                        var div_tr10 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var sum_out11 = 0;
                        var div_tr11 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var sum_out12 = 0;
                        var div_tr12 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        // total year
                        var sum_this_year = 0;
                        var div_tr_this_year = $('.table').children('tbody').children('tr').length-5;
                ...
                <?php  }
                 ...
                 ?>
                    ...
                    <tr class="tr_report" style="font-weight: bold;background: #F2F2DB !important;"> 
                        ...
                        <td style='mso-number-format:"0\.00"' id="total_top_m"></td>
                        <?php
                          if($v_date_end >=date("$year-01-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="total_top_m1"></td>
                    <?php } ?>
                    <?php
                          if($v_date_end >=date("$year-02-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="total_top_m2"></td>
                    <?php } ?>
                  <?php
                          if($v_date_end >=date("$year-03-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="total_top_m3"></td>
                <?php } ?>
                <?php
                          if($v_date_end >=date("$year-04-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="total_top_m4"></td>
                <?php } ?>
                <?php
                          if($v_date_end >=date("$year-05-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="total_top_m5"></td>
                    <?php } ?>
                <?php
                          if($v_date_end >=date("$year-06-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="total_top_m6"></td>
                    <?php } ?>
                <?php
                          if($v_date_end >=date("$year-07-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="total_top_m7"></td>
                    <?php } ?>
                    <?php
                          if($v_date_end >=date("$year-08-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="total_top_m8"></td>
                    <?php } ?>
                <?php
                          if($v_date_end >=date("$year-09-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="total_top_m9"></td>
                    <?php } ?>
                <?php
                          if($v_date_end >=date("$year-10-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="total_top_m10"></td>
                    <?php } ?>
                <?php
                          if($v_date_end >=date("$year-11-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="total_top_m11"></td>
                    <?php } ?>
                <?php
                          if($v_date_end >=date("$year-12-01") 
                        ...
                        ?>
                        <td style='mso-number-format:"0\.00"' id="total_top_m12"></td>
                    <?php } ?>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            // Total month by month
                        ...
                        var div_tr_this_month1 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var div_tr_this_month2 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var div_tr_this_month3 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var div_tr_this_month4 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var div_tr_this_month5 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var div_tr_this_month6 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var div_tr_this_month7 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var div_tr_this_month8 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var div_tr_this_month9 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var div_tr_this_month10 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var div_tr_this_month11 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var div_tr_this_month12 = $('.table').children('tbody').children('tr').length-5;
                        ...
                        var sum_total_ex = 0;
                        var div_tr_total_ex = $('.table').children('tbody').children('tr').length-5;
