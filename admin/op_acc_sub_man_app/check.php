...
<?php 
    if(isset($_POST['btn_submit'])){
        ...
        $query_update = "UPDATE `tbl_acc_request_form` 
            SET 
                sub_man_app_by='$v_check',
                sub_man_app_date='$v_date',
                sub_man_app_comment='$v_note'
            WHERE `req_id`='$v_id'";
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <?php 
                                    if($row_old_data->sub_man_app_date!='0000-00-00')
                                        $date=$row_old_data->sub_man_app_date;
                                    else
                                        $date=date('Y-m-d');
                                 ?>
                                ...
                                <?php 
                                    if($row_old_data->sub_man_app_comment)$note=$row_old_data->sub_man_app_comment;
                                    else $note="";
                                 ?>
...
<div class="modal fade" id="check">
    <div class="modal-dialog" style="border: 1px solid darkred;">
        <iframe src="iframe_add_sub_mana_app_by.php" frameborder="0" style="height: 400px; max-width: 100%; width: 100%;" align="top" scrolling="0"></iframe>
    </div>
</div>