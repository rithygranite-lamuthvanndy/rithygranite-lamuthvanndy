                            ...
                            <td>
                             ...
                             <td>
                                <select class="form-control" name="txt_category[]">
                                    ...
                                    <option value="1">សំភារៈផលិត</option>
                                    <option value="2">គ្រឿងបន្លាស់</option>
                                    <option value="3">សំភារៈរោងជាង</option>
                                    <option value="4">សំភារៈការិយាល័យ</option>
                                </select>
                            </td>
