                        ...
                        <tr class="my_form_base" style="background: red; display: none;">
                            ...
                            <td>
                                <select class="form-control" name="txt_category">
                                    ...
                                    <option <?php if($row_old->cate_id=="1") {echo "selected='selected'";} ?> value="1">សំភារៈផលិត</option>
                                    <option <?php if($row_old->cate_id=="2") {echo "selected='selected'";} ?> value="2">គ្រឿងបន្លាស់</option>
                                    <option <?php if($row_old->cate_id=="3") {echo "selected='selected'";} ?> value="3">សំភារៈរោងជាង</option>
                                    <option <?php if($row_old->cate_id=="4") {echo "selected='selected'";} ?> value="4">សំភារៈការិយាល័យ</option>
                                </select>
                            </td>
