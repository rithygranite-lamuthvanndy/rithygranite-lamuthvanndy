...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-fw fa-map-marker"></i> Cash Balance: Search by type</h2>
        </div>
    </div>
    <br>
    <div class="row">
                    ...
                    <select name="txt_month_year" class="form-control">
                        ...
                        <?php 
                            ...
                            while($row_cate = mysqli_fetch_object($v_select)){
                                if($row_cate->cftl_id == @$_POST['txt_month_year']){
                                    echo '<option SELECTED value="'.$row_cate->cftl_id.'">'.$row_cate->cftl_name.'</option>';

                                }else{
                                    echo '<option value="'.$row_cate->cftl_id.'">'.$row_cate->cftl_name.'</option>';
                ...
                <tbody>
                    <?php
                        ...
                        if(isset($_POST['btn_search'])){
                            ...
                            if(@$_POST['txt_month_year']!=""){
                                $v_type = @$_POST['txt_month_year'];
                                ...
                                WHERE cfcr_date_record BETWEEN '$v_date_s' AND '$v_date_e' AND A.cfcr_type='$v_type'
