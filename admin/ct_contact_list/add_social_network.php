...
<?php 
    if(isset($_POST['btn_submit'])){
        ...
        $v_link = @$_POST['txt_link'];
        $v_note = @$_POST['txt_note'];

        $query_add = "INSERT INTO tbl_ct_contact_social_network (
                ctsn_contact,
                ctsn_social_network_name,
                ctsn_link,
                ctsn_note
                )  
            VALUES(
                    ...
                    <div class="form-body">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group form-md-line-input">
                                    <select class="form-control" name="txt_name" required="required">
                                        <option value="">=== Please Choose and Select ===</option>
                                        <?php 
                                            $v_select = $connect->query("SELECT * FROM tbl_ct_add_social_network_name ORDER BY ctasnn_name ASC");
                                            while ($row_data = mysqli_fetch_object($v_select)) {
                                                echo '<option value="'.$row_data->ctasnn_id.'">'.$row_data->ctasnn_name.'</option>';
                                            }
                                         ?>
                                    </select>
                                    <label>Contact Name :
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group form-md-line-input">
                                    <input type="text" class="form-control" name="txt_link"  autocomplete="off">
                                    <label>Link :
                                        <span class="required" aria-required="true"></span>
                                    </label>
                                </div>
