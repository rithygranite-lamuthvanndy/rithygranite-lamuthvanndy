...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-fw fa-map-marker"></i> Report: Search by position</h2>
        </div>
    </div>
    <br>
    <div class="row">
            ...
            <div class="col-sm-2">
                <div class="" >
                    <select name="txt_position" class="form-control">
                        ...
                        <?php 
                            $category = $connect->query("SELECT * FROM tbl_ct_position ORDER BY ctpo_name ASC");
                            while($row_cate = mysqli_fetch_object($category)){
                                if($row_cate->ctpo_id == @$_POST['txt_position']){
                                    echo '<option SELECTED value="'.$row_cate->ctpo_id.'">'.$row_cate->ctpo_name.'</option>';

                                }else{
                                    echo '<option value="'.$row_cate->ctpo_id.'">'.$row_cate->ctpo_name.'</option>';
                    ...
                    <?php
                        ...
                        if(isset($_POST['btn_search'])){
                            ...
                            if(@$_POST['txt_position']!=""){
                                ...
                                WHERE ctco_date_record BETWEEN '$v_date_s' AND '$v_date_e' AND A.ctco_position='$v_position'
