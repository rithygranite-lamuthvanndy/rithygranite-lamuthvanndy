...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <h2><i class="fa fa-fw fa-map-marker"></i> Check Done List</h2>
        </div>
    </div>
    <br>
    <br>
                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_object($get_data)) {
                            echo '<tr>';
                                ...
                                echo check_list($row->req_id,$row->check_done_by);
                                echo '</td>';
                                ...
                                $sql=$connect->query("SELECT * 
                                    ...
                                    LEFT JOIN tbl_acc_check_name_list AS B ON A.check_done_by=B.chn_id WHERE req_id='$row->req_id'");
                                $row_1=mysqli_fetch_object($sql);
                                echo '<td>'.$row_1->chn_name.'</td>';
                                echo '<td>';
                                    if($row->check_done_date=='0000-00-00')
                                        echo '';
                                    else
                                        echo ($row->check_done_date);
                                echo '</td>';
                                echo '<td>'.$row->check_done_note.'</td>';
                            echo '</tr>';
                        }
                    ?>
                </tbody>
