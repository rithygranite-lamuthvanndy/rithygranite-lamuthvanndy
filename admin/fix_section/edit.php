...
<?php 
    if(isset($_POST['btn_submit'])){
        ...
        $query_update = "UPDATE `tbl_fix_section` 
            SET 
                `sect_locat`='$v_locat',
                `sect_name`='$v_name',
                `sect_note`='$v_note'
...
// get old data 
    ...
    $old_data = $connect->query("SELECT * FROM tbl_fix_section WHERE sect_id='$edit_id'");
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="#" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="txt_id" value="<?= $row_old_data->sect_id ?>">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <select name="cbo_locat" id="input" class="form-control myselect2" required="required">
                                        ...
                                        <?php 
                                            ...
                                            while ($row=mysqli_fetch_object($sql)) {
                                                if($row_old_data->sect_locat==$row->locat_id)
                                ...
                                <input value="<?= $row_old_data->sect_name ?>" type="text" name="txt_name" class="form-control" required="">
                                <br>

                                <label>Note:
                                    <span class="required" aria-required="true">*</span>
                                </label>
                                <textarea name="txt_note" rows="10" class="form-control"><?= $row_old_data->sect_note ?></textarea>
                                <br>
                            </div>
                        </div>
                    </div>
