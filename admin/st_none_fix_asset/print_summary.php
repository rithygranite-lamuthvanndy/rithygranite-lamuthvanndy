...
<body>
    <div class="main_border">
        <h3>តារាងស្ដុកឧបករណ៍ជាង នឹង ម៉ាស៊ីនខា្នតតូច <?= date('d/m/Y', strtotime($v_date_start)) . ' - ' . date('d/m/Y', strtotime($v_date_end)) ?></h3>
        <h4>Bảng Kho Thiết Bị Và Máy Kích Thước Nhỏ <?= date('d/m/Y', strtotime($v_date_start)) . ' - ' . date('d/m/Y', strtotime($v_date_end)) ?></h4>
        <br>
        <!-- Table Decription -->
        <table>
            <tbody>
