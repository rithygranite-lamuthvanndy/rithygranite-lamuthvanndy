        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">
                    ...
                    Edit Stock <?= (($_SESSION['action'] == 2) ? 'In' : 'Out') ?> Non Fixed Asset
                </h3>
            </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <textarea style="text-align: left;" placeholder="Example: B(N),C(N)&#10;Ghi Chú: B(Số),C(Số)" class="form-control" name="txt_note" rows="3">
                                        <?php echo $row_old_data->stsout_note; ?>
                                    </textarea>
                             ...
                             <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label>Out Code(Machine & Tool) : <br>
                                    Mã Máy hoặc dụng cụ</label>
<textarea style="text-align: left;" placeholder="Example: 2,4,5,6,7&#10;Ghi Chú: 2,4,5,6,7" class="form-control" name="txt_check" rows="3">
    <?php echo $row_old_data->st_out_check; ?>
</textarea>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 myTableScroll">
                                ...
                                <div style="width: 30%;float: left;">
                                     <label>Note តាមដាន : (A)​ ដាក់ប្រើប្រចាំ    <br>
    Note តាមដាន : (B)​ ប្រើបណ្ដោះអាសន្ន  <br>  
    Note តាមដាន : (C)​ តាមជាក់ស្ដែង  </label>
                                </div>
                                <div style="width: 30%;float: left;">
                                    <label>
    Ghi Chú theo dõi (A) Để Sử Dụng Thừơng Xuyên  <br>  
    Ghi Chú theo dõi (B) Sử Dụng Tạm Thời  <br>  
    Ghi Chú theo dõi (C) Theo Thực Tế
                                    </label>
                                </div>
