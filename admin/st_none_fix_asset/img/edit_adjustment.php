        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">
                    ...
                    Edit Stock Adjustment Non Fixed Asset
                </h3>
            </div>
            <div class="panel-body">
                <form action="controller_update.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="txt_parent_id" value="<?= $row_old_data->stsadj_id ?>">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                                <div class="form-group">
                                    <label>Date Stock Adjustment *:
                                    </label>
                                    <div class="input-group date" data-provide="datepicker" data-date-format="yyyy-mm-dd">
                                        <input value="<?= $row_old_data->stsadj_date_record ?>" type="text" class="form-control" value="<?= date('Y-m-d') ?>" name="txt_date_record" placeholder="Choose Date" required="" aufocomplete="off">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input value="<?= $row_old_data->stsadj_code ?>" type="text" class="form-control" name="txt_adjust_code" required=""  autocomplete="off">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                                <div class="form-group">
                                    <label>Note Problem:<br>Ghi Chú Vấn Đề </label>
                                     <textarea placeholder="Example: B(N),C(N)&#10;Ghi Chú: B(Số),C(Số)" class="form-control" name="txt_note" rows="3">
                                         <?php echo $row_old_data->stsadj_note; ?>
                                     </textarea>
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label>Adustment Code(Machine & Tool) : <br>
                                    Mã Máy hoặc dụng cụ</label>
<textarea placeholder="Example: 2,4,5,6,7&#10;Ghi Chú: 2,4,5,6,7" class="form-control" name="txt_check" rows="3">
     <?php echo $row_old_data->ajust_check; ?>
</textarea>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div style="width: 30%;float: left;">
                                     <label>Note តាមដាន : (A)(លេខសំគាល់សំភារៈ)​ គ្មានបញ្ហា<br>
        Note តាមដាន : (B)(លេខសំគាល់សំភារៈ) ខូច <br>  
        Note តាមដាន : (C)(លេខសំគាល់សំភារៈ) បាត់់</label>
                                </div>
                                <div style="width: 30%;float: left;">
                                    <label>
   Ghi Chú theo dõi (A)(số Ghi Chú vật Tư) khống vấn đề gì  <br>  
    Ghi Chú theo dõi (B)(số Ghi Chú vật Tư) Hư <br>  
       Ghi Chú theo dõi (C)(số Ghi Chú vật Tư) Mất
                                    </label>
                                </div>
                                ...
                                <table id="myTable" class="table table-bordered" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th class="text-center" style="width: 15%; word-wrap: nowrap;">Product Code</th>
                                    ...
                                    <tbody>
                                        <?php 
                                            $v_sql_child="SELECT A.*,C.stpron_code,A.id AS child_id
                                                        FROM tbl_st_stock_adjustment_detail AS A 
                                                        LEFT JOIN tbl_st_stock_adjustment  AS B ON A.stsadj_id=B.stsadj_id
                                                        LEFT JOIN tbl_st_product_name AS C ON A.pro_id=C.stpron_id
                                                        WHERE A.stsadj_id='$edit_id'
                                                        ";
                                            $v_result_child=$connect->query($v_sql_child);
                                            $v_total_amo=0;
                                            while ($row_child=mysqli_fetch_object($v_result_child)) {
                                                echo '<input type="hidden" value="'.$row_child->child_id.'" name="txt_status[]" id="inputTxt_acc_no" class="form-control">';
                                                echo '<tr>';
                                                    echo  '<td>
                                                            ...
                                                            <td>
                                                                <input type="number" step="1" name="txt_qty[]" class="form-control" value="'.$row_child->qty_adjust.'">
                                                            </td>
                                                            <td class="text-center">
                                                                <div  data_id="'.$row_child->id.'"  class="btnDelete btn btn-danger btn-xs"><i class="fa fa-trash"></i></div>
                                                            </td>';
                                                echo '</tr>';
                                            }
                                         ?>
...
<script type="text/javascript">
    ...
    $("tbody").on('click', 'div.btnDelete', function () {
        ...
        obj_delete=$(this);
        if(v_row_detail_id){
            $.get('delete_adjust.php?del_detail_id='+v_row_detail_id, function(data) {
