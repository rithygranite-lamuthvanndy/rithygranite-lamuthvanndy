    ...
    <div class="portlet-body">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-truck fa-flip-horizontal"></i> Create Stock Out (Non Fixed Asset)</h3>
            </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <textarea placeholder="Example: B(N),C(N)&#10;Ghi Chú: B(Số),C(Số)" class="form-control" name="txt_note" rows="3"></textarea>
...
<textarea placeholder="Example: 2,4,5,6,7&#10;Ghi Chú: 2,4,5,6,7" class="form-control" name="txt_check" rows="3"></textarea>
