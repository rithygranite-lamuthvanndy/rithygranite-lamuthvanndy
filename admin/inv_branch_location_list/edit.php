...
<?php 
    if(isset($_POST['btn_submit'])){
        ...
        $query_update = "UPDATE `tbl_inv_branch_location_list` 
            SET 
                `name`='$v_name',
                `note`='$v_note',
                `address`='$v_address',
...
// get old data 
    ...
    $old_data = $connect->query("SELECT * FROM tbl_inv_branch_location_list WHERE id='$edit_id'");
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    <label>Address : </label>
                                    <textarea type="text" class="form-control" name="txt_address" style="height: 80px;" autocomplete="off"><?= $row_old_data->address ?></textarea>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
