    ...
    <form action="#" method="post" accept-charset="utf-8">
        <div class="row" style="padding: 0 15px;">
                    ...
                    <select name="txt_id_emp" id="input" class="form-control myselect2" required="required">
                            ...
                            <?php 
                               ...
                               while ($row_select=mysqli_fetch_object($v_result)) {
                                    echo '<option value="'.$row_select->empl_id.'">'.$row_select->empl_card_id.' || '.$row_select->empl_emloyee_en.'</option>';
                                }
                            ?>
                    </select>
                </div>
            ...
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                ...
                <div class="form-group">
                    <label>ធ្វើការក្នុងផ្នែក: </label>
                    <select name="txt_depat" id="input" class="form-control myselect2" required="required">
                            <option value="">*** Select and choose ***</option>
                            <?php 
                               $v_result=$connect->query("SELECT * FROM tbl_hr_department_sub ORDER BY dep_id");
                               while ($row_select=mysqli_fetch_object($v_result)) {
