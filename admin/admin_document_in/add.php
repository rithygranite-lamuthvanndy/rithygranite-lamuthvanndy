...
<?php 
    if(isset($_POST['btn_submit'])){
        ...
        $query_add = "INSERT INTO tbl_admin_document_in (
                docin_date_record,
                docin_title,
                docin_description,
                docin_from,
                docin_employee_check,
                docin_department,
                user_id
                ) 
            VALUES(
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label>From :</label>
                                    <input type="text" class="form-control" name="txt_from" placeholder=" " required="required" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label>Description: </label>
                                    <textarea name="txt_des" id="inputTxt_des" class="form-control" rows="8"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
