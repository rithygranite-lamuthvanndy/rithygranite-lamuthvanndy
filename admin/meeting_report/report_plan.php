                    ...
                    <?php 
                        ...
                        while ($row_user = mysqli_fetch_object($user_query)) {
                            echo '<tr>';
                                ...
                                // echo '<td class="text-center">';
                                //     echo '<a href="edit.php?edit_id='.$row_user->meetp_id.'" class="btn btn-xs btn-warning" title="edit"><i class="fa fa-edit"></i></a> '; 
                                // //    echo '<a href="index.php?del_id='.$row_user->meetp_id.'" onclick="return confirm(\'Are u sure to  delete this user?\')" class="btn btn-xs btn-danger" title="delete"><i class="fa fa-trash"></i></a> ';
                                // echo '</td>';
                            echo '</tr>';
                        }
                    ?> 
