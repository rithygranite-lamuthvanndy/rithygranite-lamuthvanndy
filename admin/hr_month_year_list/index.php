                ...
                <tbody>
                    <?php
                        ...
                        $get_data = $connect->query("SELECT 
                               *
                            FROM  tbl_hr_month_year_list ORDER BY my_name DESC");
                        while ($row = mysqli_fetch_object($get_data)) {
                            echo '<tr>';
                                echo '<td>'.(++$i).'</td>';
                                echo '<td>'.$row->my_name.'</td>';
                                echo '<td>'.$row->my_note.'</td>';
                                echo '<td class="text-center">';
                                    echo '<a href="edit.php?edit_id='.$row->my_id.'" class="btn btn-xs btn-warning" title="edit"><i class="fa fa-edit"></i></a> ';
