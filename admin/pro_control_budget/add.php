...
<?php 
    if(isset($_POST['btn_submit'])){
        ...
        $query_add = "INSERT INTO tbl_pj_control_budget (
                cond_date_record,
                cond_project_title,
                cond_project_sub,
                cond_pay_amount,
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="txt_pay_amo"  autocomplete="off" required="">
                                </div>
                                <div class="form-group">
                                    <label>Recieve Name :  </label>
                                    <input type="text" class="form-control" name="txt_rec_name"  autocomplete="off" required="">
                                </div>
                                <div class="form-group">
                                    <label>Note :  </label>
