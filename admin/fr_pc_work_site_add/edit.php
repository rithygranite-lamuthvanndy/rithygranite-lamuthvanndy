                ...
                <div class="bs-example" data-example-id="bordered-table">
                    ...
                    <div class="panel-body">
                        <table id="myTable" class="table table-bordered myFormDetail_ns">
                            ...
                            <tbody>
                                <?php                             
                                $sql_sub = $connect->query("SELECT * FROM `tbl_acc_reqw_item_` WHERE reiw_numberw='$edit_id'");
                                while ($row_sub = mysqli_fetch_object($sql_sub)) {

                                echo '<tr>';
                                echo '   <td>
                                        <input type="hidden" name="txt_sub_id[]" value="'.$row_sub->reiw_id.'">';
                                echo '        <input type="text" class="form-control" name="txt_item_name[]" value="'.$row_sub->reiw_description .'">
                                    </td>';
                                echo '    <td>
                                ...
                                echo '    <td>
                                        <select id="unit_name" name="cbo_unit[]" id="inputCbo_position" class="form-control" required="required">
                                ...
                                echo '<td>';
                                        $amo=($row_sub->reiw_qty*$row_sub->reiw_price);
                                echo  '<input type="text" value="'.number_format($amo,2).'" name="txt_amount[]" value="0" readonly="" id="inputTxt_acc_no" class="form-control">
                                            </td>';
                                echo '    <td>
