...
<?php
    ...
    $sent_id = @$_GET['req_id'];
    $old_data = $connect->query("SELECT req_id,app_pay_by,app_pay_date,app_pay_note FROM tbl_acc_request_form WHERE req_id='$sent_id'");
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <?php 
                                    if($row_old_data->app_pay_date!='0000-00-00')
                                        $date=$row_old_data->app_pay_date;
                                    else
                                        $date=date('Y-m-d');
                                 ?>
                                ...
                                <select class="form-control myselect2" name="cbo_check">
                                    ...
                                    <?php 
                                        ...
                                        while ($row_data = mysqli_fetch_object($v_select)) {
                                            if($row_data->apn_id == @$row_old_data->app_pay_by){
                                ...
                                <textarea name="txt_note" id="inputTxt_note" class="form-control" rows="3"><?= $row_old_data->app_pay_note ?></textarea>
                                <br>
                            </div>
                        </div>
                    </div>
