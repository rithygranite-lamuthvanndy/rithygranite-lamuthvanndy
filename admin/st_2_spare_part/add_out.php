                                ...
                                <table id="myTable" class="table table-bordered myFormDetail_ns" style="width: 100%;">
                                    ...
                                    <tbody>
                                        <tr class="my_form_base" style="background: red; display: none;">
                                            <td>
                                                <select class="form-control" name="cbo_project[]" style="width: 100%;">
...
<script type="text/javascript">
    ...
    $('tbody').on('keyup', 'tr td:nth-child(5) >input', function(event) {
    ...
    //         var mc = $('#myTable').find('tbody tr:eq('+i+') td:eq(6) select').val();
